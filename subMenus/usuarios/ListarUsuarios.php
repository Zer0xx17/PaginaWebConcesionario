...
print ("<table style='position:absolute; top:$posTop; left:$posLeft; background-color:rgba(128, 128, 128, 0.7); border:2px solid black; border-radius:10px; width:500px; height:auto; padding:20px;'>\n");
print ("<tr><td style='text-align:center; font-weight:bold; font-size:20px;'>Listado de todos los usuarios</td></tr>\n");
...
if ($nfilas > 0) {
    ...
    for ($i = 0; $i < $nfilas; $i++) {
        ...
        print ("<tr>\n");
        print ("<td style='border:2px solid white; padding:5px;'>" . $resultado['password'] . "</td>\n");
        print ("<td style='border:2px solid white; padding:5px;'>" . $resultado['nombre'] . "</td>\n");
        print ("<td style='border:2px solid white; padding:5px;'>" . $resultado['apellidos'] . "</td>\n");
        print ("<td style='border:2px solid white; padding:5px;'>" . $resultado['dni'] . "</td>\n");
        print ("<td style='border:2px solid white; padding:5px;'>" . $resultado['saldo'] . "</td>\n");
        print ("</tr>\n");
    }
    print ("</table>\n");
} else {
